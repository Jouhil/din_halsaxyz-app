...
export const DEFAULT_ADAPTIVE_QUESTIONS = Object.freeze([
  ...
  { id: 'focus-stress-worry', need: 'stress', label: 'Hur mycket plats tar oron just nu?', type: 'slider' },
  { id: 'focus-stress-tension', need: 'stress', label: 'Hur spänd känns kroppen i stunden?', type: 'slider' },
  ...
  { id: 'focus-somn-rhythm', need: 'sömn', label: 'Hur stabil känns din sömnrytm idag?', type: 'slider' },
  ...
  { id: 'focus-energi-drive', need: 'energi', label: 'Hur mycket driv känner du för att göra saker?', type: 'slider' },
  ...
  { id: 'focus-tankar-speed', need: 'tankar', label: 'Hur snabbt snurrar tankarna i stunden?', type: 'slider' },
  { id: 'focus-tankar-clarity', need: 'tankar', label: 'Hur tydligt känns det i huvudet idag?', type: 'slider' },
  { id: 'focus-humor-positive', need: 'humör', label: 'Hur lätt är det att känna något positivt i stunden?', type: 'slider' },
  { id: 'focus-humor-heavy', need: 'humör', label: 'Hur tung känns känslan i kroppen?', type: 'slider' },
  { id: 'focus-humor-connection', need: 'humör', label: 'Hur nära känner du dig andra just idag?', type: 'slider' },
